...
const Search = (): JSX.Element => {
  ...
  return (
    <>
      <script src="https://static.cloud.coveo.com/searchui/v2.10095/3/js/CoveoJsSearch.Lazy.min.js"></script>
      <script src="https://static.cloud.coveo.com/searchui/v2.10095/3/js/templates/templates.js"></script>
      ...
      >
        ...
        <div className="coveo-search-section">
          ...
          <div className="CoveoSettings"></div>
        </div>
