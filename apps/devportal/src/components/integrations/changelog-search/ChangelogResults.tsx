...
export const ChangelogResults = (props: SearchResultsType) => {
  const indexSources = process.env.NEXT_PUBLIC_CHANGELOG_SEARCH_SOURCES?.split(',') || [];
...
const ChangelogResultsWidget = widget(ChangelogResults as ComponentType, WidgetDataType.SEARCH_RESULTS, 'content');
export default ChangelogResultsWidget;
