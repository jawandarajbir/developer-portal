...
| Indexing | To improve performance and optimize indexing, in the Sitecore.ContentSearch.Analytics.config file, we changed the default value of ContentSearch.Analytics.IndexAnonymousContacts setting from _true_ to _false_. We also updated the description of this setting to explicitly state that _false_ is the new default value. |  | 154817 |
